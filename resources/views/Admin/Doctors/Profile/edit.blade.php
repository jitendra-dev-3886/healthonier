        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    @endif
                    <img src="@if($data){{ $data->image_path != '' ? asset($data->image_path)  : 'assests/img/' }} @endif" alt="Dr.@if($data) {{$data->doctor_name != '' ? $data->doctor_name	  : '' }} @endif" class="rounded-circle default_img">
                ...
                <div class="">
                    ...
                    <div class="tab-content p-4 pt-0">
                        ...
                        <div class="tab-pane fade profile-edit pt-5" id="profile-edit">
                            <form class="row g-3" action="{{ route('admin.update.doctorprofile',  $data->user_id) }}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                ...
                                <div class="row mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 theme_previeww">
                                            <label>
                                                ...
                                                <div class="theme_pre">
                                                    <img title="{{$data->theme_name}}" src="@if($data->themepath != ''){{ asset($data->themepath) }}@else{{ asset('assets/img/') }}@endif" class="img-fluid" alt="...">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <img src="@if($data){{ $data->image_path != '' ? asset($data->image_path)  : asset('doctordata/doctorprofile/default/profile.png') }} @endif" alt="Profile">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-2">
                                        <img src="@if($data){{ $data->doctor_banner_path != '' ? asset($data->doctor_banner_path)  : asset('profile/assets/images/banner/banner-image-1.png') }} @endif" alt="banner-image">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <img src="@if($data){{ $data->logo_path != '' ? asset($data->logo_path)  : asset('doctordata/doctorprofile/default/logo.png') }} @endif" alt="banner-image">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <img src="@if($data){{ $data->doctor_background_banner_path != '' ? asset($data->doctor_background_banner_path)  : asset('doctordata/doctorprofile/default/banner.jpg') }} @endif" alt="banner-image">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <img src="@if($data){{ $data->fevicon_path != '' ? asset($data->fevicon_path)  : asset('doctordata/doctorprofile/default/fevicon.png') }} @endif" alt="banner-image">
