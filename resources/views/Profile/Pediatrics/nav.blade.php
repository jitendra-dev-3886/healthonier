    ...
    <div class="boxed_wrapper">
                ...
                <div class="auto-container">
                    <div class="outer-box">
                        ...
                        <div class="logo-box">
                            ...
                            <figure class="logo">
                                <a href="#home"><img src="@if($data) {{$data->logo_path != '' ? asset($data->logo_path) : asset('Pediatrics/img/logo.png')}} @endif" alt=""></a>
                            </figure>
                        </div>
                        <div class="menu-area">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="#home"><img src="assets/images/logo.png" alt="" title=""></a></div>
                ...
                <div class="contact-info">
                    ...
                    <ul>
                        <li>Noida, India</li>
                        <li><a href="tel:+124567890">124567890</a></li>
                        <li><a href="mailto:info@doctorconsultingapp.com">info@doctorconsultingapp.com</a></li>
                    </ul>
                </div>
