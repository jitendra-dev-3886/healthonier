...
<section id="about" class="about-wrap style3 ptb-100">
    <img src="{{asset('Massage/assets/img/hero/about-shape-4.webp')}}" alt="Image" class="about-shape-one md-none">
    <div class="container">
        <div class="row gx-5 align-items-center">
            <div class="col-lg-6">
                <div class="about-img-wrap" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                    <img class="about-img-one" src="@if($data) {{$data->image_path != '' ? asset($data->image_path)	  : asset('Massage/assets/img/about/about-img-4.jpg') }} @endif" alt="Image">

                    <div class="about-promo-text">
                        <h5>@if($data) {{$data->experience != '' ? $data->experience : ' 30 Years Of experience'
                            }} @endif
                    </div>
                </div>
            </div>
                    ...
                    <div class="feature-item-wrap">
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                ...
                                <p>@if($data) {{$data->name != '' ? $data->name : ' Massage Therapist'
                                    }} @endif </p>
                            </div>
                        </div>
                        <div class="feature-item">
                            ...
                            <div class="feature-text">
                                <h5>Doctor Degree</h5>
                                <p>@if($data) {{$data->degree != '' ? $data->degree : ' MBBS, ENT'
                                    }} @endif</p>
                            </div>
                        </div>
                    </div>
