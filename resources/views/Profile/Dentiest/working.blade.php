<section class="working-process style-two" id="working">
    <style>
        .st-shedule-list {
    ...
    <div class="sec-bg" style="background-image: url({{asset('Dentiest/assets/images/shape/shape-22.png')}});">
    </div>
    <div class="auto-container">
        ...
        <div class="row">
            <div class="col-lg-6 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.2s; animation-name: fadeInLeft;">
                <div class="image">
                    <img src="{{asset('Dentiest/assets/images/resource/working.jpg')}}">
                </div>
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.2s; animation-name: fadeInRight;">
                <div class="st-shedule-wrap">
                    <div class="st-shedule">
                        <h2 class="st-shedule-title">Weekly Timetable</h2>
                        <table class="st-shedule-list">
                            <thead>
                                <tr>
                                    <th>Locations</th>
                                    <th>Days</th>
        ...
        ?>
                                ...
                                <tr>
                                    <td>{{$item->name}}</td>
                                    <?php
            // $timeslot = Timeslot::where('id', $item->clinic_availabilities->timeslot_id)->first();
            ...
            ?>
                        ...
                        <div class="st-call st-style1 pt-3">
                  ...
                  c8.481,0,15.354-6.875,15.356-15.354C356.215,211.732,348.444,192.968,333.737,178.26z"></path>
                            ...
                            <div class="st-call-text">
                                ...
                                <div class="st-call-number">(+01) - 123 456 789</div>
                            </div>
                        </div>
                    </div>
                </div>
